...
class PaginatorView(discord.ui.View):
    def __init__(self, pages: List[str], title: str, color: int, ephemeral: bool, interaction: discord.Interaction):
...
async def render_and_truncate_table(
    ...
    header_str = "\n".join([f"\u001b[1;37m{line}\u001b[0m" for line in header_lines]) + "\n"
...
async def send_success(
    interaction: discord.Interaction, message: str, title: str = "Success", ephemeral: bool = True
) -> None:
...
async def send_error(
    interaction: discord.Interaction, message: str, title: str = "Error", ephemeral: bool = True
) -> None:
